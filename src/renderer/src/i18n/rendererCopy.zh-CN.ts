...
export const zhCN = {
  ...
  "app.worktreeCreateSession": "创建并打开会话",
  ...
  "app.worktreeSessionCreateFailed": "工作区已创建，但隔离会话启动失败，请重试。",
  ...
  "app.worktreeStatusHint": "该工作区有 Git 更改",
  "app.worktreeStatusChanged": "{count} 项更改",
  "app.worktreeStatusConflicts": "{count} 个冲突",
  "app.worktreeStatusUnavailable": "状态不可用",
  ...
  "projectIdeas.title": "项目想法",
  "projectIdeas.workspaceEntry": "当前工作区的项目想法",
  "projectIdeas.projectOverviewEntry": "查看整个项目各工作区的想法",
  "projectIdeas.projectOverviewTitle": "项目想法总览",
  "projectIdeas.projectOverviewHint": "按工作区分组查看；主工作区与其他工作区的想法彼此独立。",
  "projectIdeas.manageWorkspace": "查看与管理",
  "projectIdeas.backToOverview": "返回项目想法总览",
  "projectIdeas.ideaCount": "{count} 条想法",
  "projectIdeas.workspaceEmpty": "这个工作区还没有想法，点击新建",
  "projectIdeas.workspaceLoadFailed": "这个工作区的想法加载失败，已保留其他工作区的结果。",
  "projectIdeas.overviewLoadFailed": "当前工作区清单同步失败，请重试。",
  "projectIdeas.noWorkspaces": "这个项目暂无可用工作区",
  "projectIdeas.kindLabel": "想法类型",
  "projectIdeas.kind.implementation": "正式开发",
  "projectIdeas.kind.brainstorm": "头脑风暴（只讨论方案）",
  "projectIdeas.plansTitle": "候选方案",
  "projectIdeas.plansHint": "基于完整头脑风暴会话整理方案；采纳后会创建可继续编辑的正式开发想法。",
  "projectIdeas.plansExtract": "整理候选方案",
  "projectIdeas.plansExtracting": "正在整理方案…",
  ...
  "projectIdeas.brainstormSummaryHint": "先在头脑风暴会话中多轮交流；确认当前方向后，再由 AI 归纳成一条可编辑的项目想法。",
  "projectIdeas.brainstormSummarize": "AI 归纳当前讨论",
  "projectIdeas.brainstormSummarizing": "正在归纳…",
  "projectIdeas.adoptPlan": "采纳方案",
  "projectIdeas.planGoal": "目标",
  "projectIdeas.planScope": "范围",
  "projectIdeas.planAdvantages": "优点",
  "projectIdeas.planDisadvantages": "缺点",
  "projectIdeas.planRisks": "风险",
  "projectIdeas.planQuestions": "待确认问题",
  "projectIdeas.brainstormRefinementTitle": "头脑风暴整理稿",
  "projectIdeas.brainstormRefinementHint": "这是当前头脑风暴会话的归纳草稿；确认后仍可直接从同一条想法开始正式开发。",
  "projectIdeas.brainstormSummary": "讨论主题",
  "projectIdeas.brainstormBackground": "背景与问题",
  "projectIdeas.brainstormGoal": "讨论目标",
  "projectIdeas.brainstormOutcome": "期望产出",
  "projectIdeas.brainstormOptions": "已讨论方向（每行一项）",
  "projectIdeas.brainstormTradeoffs": "方案比较维度与优缺点（每行一项）",
  "projectIdeas.new": "新建想法",
  "projectIdeas.edit": "编辑想法",
  "projectIdeas.all": "全部",
  "projectIdeas.empty": "还没有项目想法",
  "projectIdeas.noBody": "暂无正文",
  "projectIdeas.titlePlaceholder": "想法标题",
  "projectIdeas.bodyPlaceholder": "记录背景、动机和以后可以怎么做…",
  "projectIdeas.bodyHint": "支持 Markdown；直接粘贴图片会通过 PicGo 上传并插入外链。",
  "projectIdeas.previewBody": "预览",
  "projectIdeas.editBody": "编辑",
  "projectIdeas.uploadingImage": "正在上传图片…",
  "projectIdeas.imageUploadFailed": "图片上传失败，请确认 PicGo 正在运行且已配置图床。",
  "projectIdeas.tagsPlaceholder": "标签，用逗号分隔",
  "projectIdeas.selectHint": "选择一个想法，或新建一条记录",
  "projectIdeas.save": "保存",
  "projectIdeas.cancel": "取消",
  ...
  "projectIdeas.sourceSelection": "来源：选中文本",
  "projectIdeas.deleteConfirm": "确定删除这条项目想法吗？后续想法会保留并提升为根节点，删除后无法恢复。",
  "projectIdeas.addFollowUp": "添加后续想法",
  "projectIdeas.addFollowUpAria": "为“{title}”添加后续想法",
  "projectIdeas.followUpContext": "后续于：{title}",
  "projectIdeas.parentNotFound": "父级想法不存在，请刷新后重试。",
  "projectIdeas.parentProjectMismatch": "父级想法不属于当前项目。",
  "projectIdeas.parentCycle": "不能建立循环的后续关系。",
  "projectIdeas.continuePrompt": "请基于下面的项目想法，先帮我分析实现方案，不要直接修改代码。\n\n标题：{title}\n\n想法内容：\n{body}",
  "projectIdeas.refinementTitle": "AI 整理稿",

  "projectIdeas.refinementHint": "原始记录不会被覆盖；你可以编辑整理结果，确认后再执行。",
  "projectIdeas.refinementUseContext": "结合当前会话上下文（只读）",
  "projectIdeas.refining": "正在整理…",
  "projectIdeas.refineAgain": "重新整理",
  "projectIdeas.refinementEmpty": "点击“AI 整理”，把这条随笔归纳成可确认的项目想法。",
  "projectIdeas.refinementSummary": "一句话目标",
  "projectIdeas.refinementProblem": "要解决的问题",
  "projectIdeas.refinementGoal": "目标",
  "projectIdeas.refinementOutcome": "期望结果",
  "projectIdeas.refinementScope": "建议范围（每行一项）",
  "projectIdeas.refinementAcceptance": "验收标准（每行一项）",
  "projectIdeas.refinementQuestions": "待确认问题（每行一项）",
  "projectIdeas.acceptRefinement": "确认整理稿",
  "projectIdeas.refinementConfirmed": "已确认",
  "projectIdeas.saving": "保存中…",
  "projectIdeas.saved": "已保存",
  "projectIdeas.saveFailed": "保存失败",
  "projectIdeas.defaultModel": "默认模型",
  "projectIdeas.thinkingLevel": "推理强度",
  "projectIdeas.defaultThinking": "默认强度",
  "projectIdeas.confirmThinking": "确认",
  "projectIdeas.thinkingConfirmed": "推理强度已确认",
  "projectIdeas.thinkingConfirmedShort": "已确认",
  "projectIdeas.execute": "开始实现",
  "projectIdeas.executing": "正在开始…",
  "projectIdeas.backgroundTaskCompletedTitle": "项目想法任务已完成",
  "projectIdeas.backgroundTaskFailedTitle": "项目想法任务失败",
  "projectIdeas.backgroundRefinementCompleted": "“{title}”的 AI 整理稿已完成，重新打开项目想法即可查看。",
  "projectIdeas.backgroundRefinementFailed": "“{title}”的 AI 整理稿处理失败，请重新打开项目想法后重试。",
  "projectIdeas.backgroundPlansCompleted": "“{title}”的 AI 归纳已完成，重新打开项目想法即可查看。",
  "projectIdeas.backgroundPlansFailed": "“{title}”的 AI 归纳失败，请重新打开项目想法后重试。",
  "projectIdeas.status.inbox": "待整理",
  "projectIdeas.status.planned": "计划中",
  "projectIdeas.status.doing": "进行中",
  "projectIdeas.status.done": "已完成",
  "app.files": "文件",
  "app.model": "模型",
  "app.new": "新会话",
  "app.newSession": "新建会话",
  ...
  "app.projectRemoveBodyWithIdeas": "确定删除项目「{name}」吗？该项目下的会话和项目想法也会一并删除，且无法恢复。",
  ...
  "command.actionStopAgent": "停止当前 Agent",
  "command.actionStopAgentDesc": "结束进程但保留会话与 Tab，可随时再启动",
  ...
  "app.sshSelectHost": "选择 SSH 主机",
  "app.sshSelectHostShort": "SSH 主机",
  "app.sshSwitchHost": "切换 SSH 主机",
  "app.sshControlTitle": "SSH 主机",
  "app.sshUnlockDescription": "输入 SSH 管理器主密码",
  "app.sshSelectDescription": "选择当前 SSH 主机",
  "app.sshPasswordPlaceholder": "主密码",
  ...
  "workbuddy.emptyDesc":
    "只会扫描 `~/.workbuddy/projects` 中 cwd 与当前项目一致的会话。",
  ...
  "cursor.emptyDesc":
    "只会扫描 `~/.cursor/projects` 中与当前项目路径对应的 Agent 会话。",
  ...
  "zcode.emptyDesc":
    "只会扫描 `~/.zcode/cli/db/db.sqlite` 中 directory 与当前项目一致的会话。",
  ...
  "config.tokendance.keyDesc":
    "模型请求按 TokenDance 账户计费，需要 API Key。可以粘贴已有 Key，或通过授权页自动创建（归因到 PiDeck）。",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "config.builtInExtDesc.pi-deck-maestro-auto-approve": "Plan 确认适配：把 pi-maestro-flow 的计划确认接入 PiDeck 的审批 UI，状态与计划仍由上游维护。",
  "config.builtInExtDesc.pi-deck-knowledge-adherence": "项目知识自动遵循：每轮任务前从 pi-maestro-flow 项目知识库检索并加载相关规则，注入当前上下文；知识不可用时明确提示，不擅自执行或授权。",
...
"config.proxyUrlUnset": "未配置代理 URL",
  ...
  "settings.gitAutoSync": "自动同步主分支",
  "settings.gitAutoSyncDesc": "仅对干净工作区执行 fetch 与快进；无法安全同步时保持不变并提示原因。",
  "settings.gitAutoSyncInterval": "同步间隔（分钟）",
  "settings.gitAutoSyncIntervalDesc": "范围 5–1440 分钟。",
  "settings.gitAutoSyncStartup": "启动时同步",
  "settings.gitAutoSyncStartupDesc": "应用启动后尝试同步一次主分支。",
  "settings.gitAutoSyncWorktrees": "同步关联 worktree",
  "settings.gitAutoSyncWorktreesDesc": "主分支成功快进后，同步干净且同名的关联 worktree。",
  "settings.gitCommitMessagePrompt": "Git 提交摘要提示词",
  "git.mainSync": "同步主分支",
  "git.mainSyncSuccess": "主分支同步完成",
  "git.mainSyncFailed": "主分支同步失败",
  "git.mainSyncBlocked": "主分支暂未同步：{reason}",
  "git.mainSyncReasonDirty": "工作区有未提交修改",
  "git.mainSyncReasonConflicted": "工作区存在合并冲突",
  "git.mainSyncReasonActive": "当前工作区正被 Agent 使用",
  "git.mainSyncReasonDiverged": "分支已发生分叉",
  "git.mainSyncReasonLocalAhead": "本地分支领先远程",
  "git.mainSyncReasonRemoteFailed": "无法获取远程更新",
  "git.mainSyncReasonNoUpstream": "没有匹配的上游分支",
  "git.mainSyncReasonUnavailable": "工作区不可用",
  "git.mainSyncReasonBusy": "另一个 Git 操作正在运行",
  "git.mainSyncReasonNoMainBranch": "未找到主分支",
  "git.mainSyncReasonMissingWorktree": "主工作区不可用",
  "git.mainSyncReasonDifferentBranch": "工作区当前处于其他分支",
  "git.mainSyncReasonFailed": "快进操作失败",
  ...
  "settings.projectIdeaRefinementModel": "头脑风暴整理与项目想法归纳模型",
  "settings.projectIdeaRefinementModelDesc": "选择头脑风暴整理稿和项目想法归纳使用的模型；留空则跟随 pi 默认模型。",
  "settings.projectIdeaRefinementModelUnset": "跟随 pi 默认模型",
  "settings.projectIdeaRefinementThinkingLevel": "头脑风暴整理与归纳推理强度",
  ...
  "settings.autoSessionTitleDesc": "首轮 Agent 成功结束后，用会话名称设置中选择的模型（未配置则跟随当前 pi 模型）异步生成标题；会额外消耗一次模型调用和少量 token，不修改主提示词或会话消息。关闭后需新建或重启 Agent 才生效。",
  "settings.autoSessionTitleModel": "会话名称生成模型",
  "settings.autoSessionTitleModelDesc": "选择用于生成会话名称的模型和推理强度；留空则跟随当前会话模型。",
  "settings.autoSessionTitleModelUnset": "跟随当前会话模型",
  "settings.autoSessionTitleThinkingLevel": "会话名称推理强度",
  "settings.autoSessionTitleThinkingLevelDefault": "使用模型默认强度",
  ...
  "settings.updateGithubFailHint": "GitHub 无法连接时，请检查网络或代理后重试。应用更新仅使用 GitHub 上的 jintongxu/PiDeck。",
  ...
  "settings.enableNotifications": "Agent 完成响应、报错时发送系统通知",
  "settings.enableNotificationsDesc": "与应用内右上角错误提示同时显示；关闭后仅保留应用内提示",
