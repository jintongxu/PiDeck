...
export const enUS: Record<TranslationKey, string> = {
  ...
  "app.worktreeCreateSession": "Create and open session",
  ...
  "app.worktreeSessionCreateFailed": "Workspace created, but the isolated session could not be started: ",
  ...
  "app.worktreeStatusHint": "Git changes in this workspace",
  "app.worktreeStatusChanged": "{count} changed",
  "app.worktreeStatusConflicts": "{count} conflicts",
  "app.worktreeStatusUnavailable": "Status unavailable",
  ...
  "projectIdeas.title": "Project ideas",
  "projectIdeas.workspaceEntry": "Ideas for this workspace",
  "projectIdeas.projectOverviewEntry": "View ideas across all project workspaces",
  "projectIdeas.projectOverviewTitle": "Project ideas overview",
  "projectIdeas.projectOverviewHint": "Grouped by workspace. Ideas in the main workspace and other workspaces remain isolated.",
  "projectIdeas.manageWorkspace": "View and manage",
  "projectIdeas.backToOverview": "Back to project ideas overview",
  "projectIdeas.ideaCount": "{count} ideas",
  "projectIdeas.workspaceEmpty": "No ideas in this workspace yet. Click to create one.",
  "projectIdeas.workspaceLoadFailed": "Ideas for this workspace failed to load. Results from other workspaces are preserved.",
  "projectIdeas.overviewLoadFailed": "Failed to synchronize the current workspace list. Try again.",
  "projectIdeas.noWorkspaces": "No available workspaces in this project",
  "projectIdeas.kindLabel": "Idea type",
  "projectIdeas.kind.implementation": "Implementation",
  "projectIdeas.kind.brainstorm": "Brainstorm (discussion only)",
  "projectIdeas.plansTitle": "Candidate plans",
  "projectIdeas.plansHint": "Plans are extracted from the complete brainstorm session; adopting one creates an editable implementation idea.",
  "projectIdeas.plansExtract": "Extract candidate plans",
  "projectIdeas.plansExtracting": "Extracting plans…",
  ...
  "projectIdeas.brainstormSummaryHint": "Discuss across multiple turns first. When the direction is ready, ask AI to turn the current discussion into one editable project idea.",
  "projectIdeas.brainstormSummarize": "Summarize current discussion",
  "projectIdeas.brainstormSummarizing": "Summarizing…",
  "projectIdeas.adoptPlan": "Adopt plan",
  "projectIdeas.planGoal": "Goal",
  "projectIdeas.planScope": "Scope",
  "projectIdeas.planAdvantages": "Advantages",
  "projectIdeas.planDisadvantages": "Disadvantages",
  "projectIdeas.planRisks": "Risks",
  "projectIdeas.planQuestions": "Open questions",
  "projectIdeas.brainstormRefinementTitle": "Brainstorm outline",
  "projectIdeas.brainstormRefinementHint": "This is a draft summary of the current brainstorm; after confirmation, the same idea can start formal implementation.",
  "projectIdeas.brainstormSummary": "Discussion topic",
  "projectIdeas.brainstormBackground": "Background and problem",
  "projectIdeas.brainstormGoal": "Discussion goal",
  "projectIdeas.brainstormOutcome": "Expected output",
  "projectIdeas.brainstormOptions": "Discussed directions (one per line)",
  "projectIdeas.brainstormTradeoffs": "Comparison dimensions and trade-offs (one per line)",
  "projectIdeas.new": "New idea",
  "projectIdeas.edit": "Edit idea",
  "projectIdeas.all": "All",
  "projectIdeas.empty": "No project ideas yet",
  "projectIdeas.noBody": "No details",
  "projectIdeas.titlePlaceholder": "Idea title",
  "projectIdeas.bodyPlaceholder": "Capture the context, motivation, and possible next steps…",
  "projectIdeas.bodyHint": "Markdown is supported. Paste an image to upload it through PicGo.",
  "projectIdeas.previewBody": "Preview",
  "projectIdeas.editBody": "Edit",
  "projectIdeas.uploadingImage": "Uploading image…",
  "projectIdeas.imageUploadFailed": "Image upload failed. Check that PicGo is running and configured.",
  "projectIdeas.tagsPlaceholder": "Tags, separated by commas",
  "projectIdeas.selectHint": "Select an idea or create a new one",
  "projectIdeas.save": "Save",
  "projectIdeas.cancel": "Cancel",
  ...
  "projectIdeas.sourceSelection": "Source: selected text",
  "projectIdeas.deleteConfirm": "Delete this project idea? Any follow-up ideas will be kept and promoted to the root. This cannot be undone.",
  "projectIdeas.addFollowUp": "Add follow-up idea",
  "projectIdeas.addFollowUpAria": "Add a follow-up idea to {title}",
  "projectIdeas.followUpContext": "Follow-up to: {title}",
  "projectIdeas.parentNotFound": "The parent idea no longer exists. Refresh and try again.",
  "projectIdeas.parentProjectMismatch": "The parent idea belongs to another project.",
  "projectIdeas.parentCycle": "A follow-up relationship cannot create a cycle.",
  "projectIdeas.continuePrompt": "Based on the project idea below, analyze an implementation plan first. Do not modify files yet.\n\nTitle: {title}\n\nIdea:\n{body}",
  "projectIdeas.refinementTitle": "AI clarification",
  "projectIdeas.refinementHint": "The original note stays unchanged. Edit the clarification, then confirm it before execution.",
  "projectIdeas.refinementUseContext": "Use the current session context (read-only)",
  "projectIdeas.refining": "Clarifying…",
  "projectIdeas.refineAgain": "Clarify again",
  "projectIdeas.refinementEmpty": "Click “AI clarification” to turn this note into a confirmable project idea.",
  "projectIdeas.refinementSummary": "One-line goal",
  "projectIdeas.refinementProblem": "Problem to solve",
  "projectIdeas.refinementGoal": "Goal",
  "projectIdeas.refinementOutcome": "Expected outcome",
  "projectIdeas.refinementScope": "Suggested scope (one item per line)",
  "projectIdeas.refinementAcceptance": "Acceptance criteria (one item per line)",
  "projectIdeas.refinementQuestions": "Open questions (one item per line)",
  "projectIdeas.acceptRefinement": "Confirm clarification",
  "projectIdeas.refinementConfirmed": "Confirmed",
  "projectIdeas.saving": "Saving…",
  "projectIdeas.saved": "Saved",
  "projectIdeas.saveFailed": "Save failed",
  "projectIdeas.defaultModel": "Default model",
  "projectIdeas.thinkingLevel": "Thinking level",
  "projectIdeas.defaultThinking": "Default level",
  "projectIdeas.confirmThinking": "Confirm",
  "projectIdeas.thinkingConfirmed": "Thinking level confirmed",
  "projectIdeas.thinkingConfirmedShort": "Confirmed",
  "projectIdeas.execute": "Start implementation",
  "projectIdeas.executing": "Starting…",
  "projectIdeas.backgroundTaskCompletedTitle": "Project idea task completed",
  "projectIdeas.backgroundTaskFailedTitle": "Project idea task failed",
  "projectIdeas.backgroundRefinementCompleted": "AI clarification for “{title}” is ready. Reopen project ideas to view it.",
  "projectIdeas.backgroundRefinementFailed": "AI clarification for “{title}” failed. Reopen project ideas and try again.",
  "projectIdeas.backgroundPlansCompleted": "AI summary for “{title}” is ready. Reopen project ideas to view it.",
  "projectIdeas.backgroundPlansFailed": "AI summary for “{title}” failed. Reopen project ideas and try again.",
  "projectIdeas.status.inbox": "Inbox",
  "projectIdeas.status.planned": "Planned",
  "projectIdeas.status.doing": "Doing",
  "projectIdeas.status.done": "Done",
  "app.files": "Files",
  "app.model": "Model",
  "app.new": "New Session",
  ...
  "app.projectRemoveBodyWithIdeas": "Remove project \"{name}\"? Its sessions and project ideas will also be deleted and cannot be recovered.",
  ...
  "app.sshSelectHost": "Select SSH host",
  "app.sshSelectHostShort": "SSH host",
  "app.sshSwitchHost": "Switch SSH host",
  "app.sshControlTitle": "SSH host",
  "app.sshUnlockDescription": "Enter the SSH manager master password",
  "app.sshSelectDescription": "Select the current SSH host",
  "app.sshPasswordPlaceholder": "Master password",
  ...
  "cursor.emptyDesc":
    "Only scans Cursor Agent sessions under `~/.cursor/projects` that match this project path.",
  ...
  "zcode.emptyDesc":
    "Only sessions whose directory matches this project are scanned from `~/.zcode/cli/db/db.sqlite`.",
  ...
  "config.tokendance.keyDesc":
    "Model requests are billed to your TokenDance account and need an API Key. Paste an existing one, or create one via the authorization page (attributed to PiDeck).",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "config.builtInExtDesc.pi-deck-maestro-auto-approve": "Plan confirmation adapter: connects pi-maestro-flow plan confirmation to PiDeck's approval UI while upstream remains the owner of Plan state.",
  "config.builtInExtDesc.pi-deck-knowledge-adherence": "Project knowledge adherence: searches and loads relevant pi-maestro-flow project rules before each turn, adds them to the current context, and reports unavailable knowledge without assuming or granting permission.",
...
"config.proxyUrlUnset": "No proxy URL configured",
  ...
  "settings.gitAutoSync": "Auto-sync main branch",
  "settings.gitAutoSyncDesc": "Only fetch and fast-forward clean worktrees; unsafe cases remain unchanged with a reason.",
  "settings.gitAutoSyncInterval": "Sync interval (minutes)",
  "settings.gitAutoSyncIntervalDesc": "Range: 5–1440 minutes.",
  "settings.gitAutoSyncStartup": "Sync on startup",
  "settings.gitAutoSyncStartupDesc": "Try syncing the main branch once after startup.",
  "settings.gitAutoSyncWorktrees": "Sync linked worktrees",
  "settings.gitAutoSyncWorktreesDesc": "After main advances, sync clean linked worktrees on the same branch.",
  "settings.gitCommitMessagePrompt": "Git Commit Message Prompt",
  "git.mainSync": "Sync main",
  "git.mainSyncSuccess": "Main branch synced",
  "git.mainSyncFailed": "Main branch sync failed",
  "git.mainSyncBlocked": "Main branch not synced: {reason}",
  "git.mainSyncReasonDirty": "the worktree has uncommitted changes",
  "git.mainSyncReasonConflicted": "the worktree has merge conflicts",
  "git.mainSyncReasonActive": "an Agent is using the worktree",
  "git.mainSyncReasonDiverged": "the branch has diverged",
  "git.mainSyncReasonLocalAhead": "the local branch is ahead",
  "git.mainSyncReasonRemoteFailed": "the remote could not be fetched",
  "git.mainSyncReasonNoUpstream": "no matching upstream branch",
  "git.mainSyncReasonUnavailable": "the worktree is unavailable",
  "git.mainSyncReasonBusy": "another Git operation is running",
  "git.mainSyncReasonNoMainBranch": "no main branch was found",
  "git.mainSyncReasonMissingWorktree": "the main worktree is unavailable",
  "git.mainSyncReasonDifferentBranch": "the worktree is on another branch",
  "git.mainSyncReasonFailed": "the fast-forward operation failed",
  ...
  "settings.projectIdeaRefinementModel": "Brainstorm and project idea summary model",
  "settings.projectIdeaRefinementModelDesc": "Choose the model used for brainstorm outlines and project idea summaries; leave empty to follow pi defaults.",
  "settings.projectIdeaRefinementModelUnset": "Use pi default model",
  "settings.projectIdeaRefinementThinkingLevel": "Brainstorm and summary reasoning effort",
  ...
  "settings.autoSessionTitleDesc": "After the first Agent run succeeds, use the model selected below (or the current pi model when unset) to generate a title asynchronously. This makes one extra model call and consumes a small amount of tokens, without changing the main prompt or messages. Restart or create an Agent after changing this setting.",
  "settings.autoSessionTitleModel": "Session title model",
  "settings.autoSessionTitleModelDesc": "Choose the model and reasoning level used to generate session titles; leave empty to follow the current session model.",
  "settings.autoSessionTitleModelUnset": "Follow current session model",
  "settings.autoSessionTitleThinkingLevel": "Session title reasoning level",
  "settings.autoSessionTitleThinkingLevelDefault": "Use model default",
  ...
  "settings.updateGithubFailHint": "If GitHub is unreachable, check your network or proxy and retry. App updates only use jintongxu/PiDeck on GitHub.",
