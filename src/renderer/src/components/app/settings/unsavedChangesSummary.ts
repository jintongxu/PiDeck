...
const FIELD_CATALOG: readonly FieldCatalogEntry[] = [
	...
	{ field: "autoSessionTitleProvider", tab: "common", itemKey: "settings.autoSessionTitleModel" },
	{ field: "autoSessionTitleModel", tab: "common", itemKey: "settings.autoSessionTitleModel" },
	{ field: "autoSessionTitleThinkingLevel", tab: "common", itemKey: "settings.autoSessionTitleThinkingLevel" },
